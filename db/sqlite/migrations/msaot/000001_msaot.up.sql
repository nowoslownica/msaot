...
insert into flexies values(7, 'маме', 'мама', 'n', 7);
insert into flexies values(8, 'мамо', 'мама', 'n', 8);
insert into flexies values(9, 'мамы', 'мама', 'n', 9);
insert into flexies values(10, 'мам', 'мама', 'n', 10);
insert into flexies values(11, 'мамам', 'мама', 'n', 11);
insert into flexies values(12, 'мамам', 'мама', 'n', 12);
insert into flexies values(13, 'мамах', 'мама', 'n', 13);
insert into flexies values(14, 'мамах', 'мама', 'n', 14);
insert into flexies values(15, 'мамы', 'мама', 'n', 15);
-- declension 1B
