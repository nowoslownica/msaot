...
func testGrammarPositionToManyAddOpGPositionFlexies(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if first.R.GPositionGrammarPosition != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}
		if second.R.GPositionGrammarPosition != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}
...
func testGrammarPositionToManySetOpGPositionFlexies(t *testing.T) {
	...
	if b.R.GPositionGrammarPosition != nil {
		t.Error("relationship was not removed properly from the foreign struct")
	}
	if c.R.GPositionGrammarPosition != nil {
		t.Error("relationship was not removed properly from the foreign struct")
	}
	if d.R.GPositionGrammarPosition != &a {
		t.Error("relationship was not added properly to the foreign struct")
	}
	if e.R.GPositionGrammarPosition != &a {
		t.Error("relationship was not added properly to the foreign struct")
	}
