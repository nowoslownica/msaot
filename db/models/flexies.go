...
type flexyR struct {
	GPosition *GrammarPosition `boil:"GPosition" json:"GPosition" toml:"GPosition" yaml:"GPosition"`
}
...
// GPosition pointed to by the foreign key.
func (o *Flexy) GPosition(mods ...qm.QueryMod) grammarPositionQuery {
...
// LoadGPosition allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (flexyL) LoadGPosition(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFlexy interface{}, mods queries.Applicator) error {
	var slice []*Flexy
	var object *Flexy
...
// SetGPosition of the flexy to the related item.
// Sets o.R.GPosition to related.
// Adds o to related.R.GPositionFlexies.
func (o *Flexy) SetGPosition(ctx context.Context, exec boil.ContextExecutor, insert bool, related *GrammarPosition) error {
	var err error
	if insert {
...
// RemoveGPosition relationship.
// Sets o.R.GPosition to nil.
// Removes o from all passed in related items' relationships struct (Optional).
func (o *Flexy) RemoveGPosition(ctx context.Context, exec boil.ContextExecutor, related *GrammarPosition) error {
	var err error
...
func FlexyItemsPaginated(
	...
	limitQuery = append(limitQuery, qm.OrderBy("\"flexies\".id"))
	items, err := Flexies(limitQuery...).All(ctx, exec)
	if err != nil {
		return nil, 0, err
	}
	count, err := Flexies(where...).Count(ctx, exec)
	if err != nil {
		return nil, 0, err
	}
...
var FlexyColumnExists = map[string]struct{}{
	"id":        {},
	"value":     {},
	"normal":    {},
	"pos":       {},
...
var FlexyFieldToColumn = map[string]string{
	"ID":        "flexies.id",
	"Value":     "flexies.value",
	"Normal":    "flexies.normal",
	"Pos":       "flexies.pos",
	"GPosition": "flexies.gPosition",
}
